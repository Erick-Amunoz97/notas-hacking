...
## Solucion
usamos el peurto que se nos proporciona y nos da este mensaje encripto:
```bash()
┌──(kali㉿kali)-[~/LaCifraDe]
...
```
usamos el vigenere para decodificarlo el unico problema es que no conocemos la llave. usamos un decrptador automatico para hayar la llave. 
nos da que la llave es "flag"
lo qual nos da este texto :
